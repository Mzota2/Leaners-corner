...
import {ArtLessonsData} from '../subjectData/artsData';

import './history.css'

export default function ArtLessons(){
    const [historyData , setHistoryData] = React.useState(ArtLessonsData);
    ...
    function handleClick(){
        if(formData.level === 'all'){
            setHistoryData(ArtLessonsData);
        }
       if(formData.level === 'form1'){
           
           setHistoryData(prevData =>{
                prevData = ArtLessonsData;
