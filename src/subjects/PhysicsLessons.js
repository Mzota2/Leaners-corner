...
import { PhysicsLessonsData } from "../subjectData/physicsData";

import './history.css'

export default function PhysicsLessons(){
    const [historyData , setHistoryData] = React.useState(PhysicsLessonsData);
    ...
    function handleClick(){
        if(formData.level === 'all'){
            setHistoryData(PhysicsLessonsData);
        }
       if(formData.level === 'form1'){
           
           setHistoryData(prevData =>{
                prevData = PhysicsLessonsData;
