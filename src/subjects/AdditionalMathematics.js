...
import { AdmaData } from "../subjectData/admaData";

 export default function AdmaQuiz(props){

  const [historyData, setData]=React.useState(AdmaData);
  ...
  function handleNext(){
    ...
    return(
      ...
      <div>
         {currentIndex>=historyData.length-1?<p className="score">Score:{score}</p>:console.log('we')}
      
         {currentIndex >=historyData.length-1?console.log('me'):<div onClick={handleAnswer}className="answer" id="answer">{answer.text}</div>}
    ...
    <main>
        ...
        <div className="questions_container">
            ...
            <NavLink to='/admaLessons'><p className="hs--goto">Go To Lessons<i class=" fab fas fa-angle-double-right"></i></p></NavLink>
