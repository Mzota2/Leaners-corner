...
import { AdmaLessonsData } from "../subjectData/admaData";

import './history.css'

export default function AdmaLessons(){
    const [historyData , setHistoryData] = React.useState(AdmaLessonsData);
    ...
    function handleClick(){
        if(formData.level === 'all'){
            setHistoryData(AdmaLessonsData);
        }
       if(formData.level === 'form1'){
           
           setHistoryData(prevData =>{
                prevData = AdmaLessonsData;
