...
import { SocialLessonsData } from "../subjectData/socialData";

import './history.css'

export default function SocialLessons(){
    const [historyData , setHistoryData] = React.useState(SocialLessonsData);
    ...
    function handleClick(){
        if(formData.level === 'all'){
            setHistoryData(SocialLessonsData);
        }
       if(formData.level === 'form1'){
           
           setHistoryData(prevData =>{
                prevData = SocialLessonsData;
