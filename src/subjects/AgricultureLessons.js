...
import { AgriLessonsData } from "../subjectData/agricuData";

import './history.css'

export default function ArtLessons(){
    const [historyData , setHistoryData] = React.useState(AgriLessonsData);
    ...
    function handleClick(){
        if(formData.level === 'all'){
            setHistoryData(AgriLessonsData);
        }
       if(formData.level === 'form1'){
           
           setHistoryData(prevData =>{
                prevData = AgriLessonsData;
