...
import { FrenchLessonsData } from "../subjectData/frenchData";

import './history.css'

export default function FrenchLessons(){
    const [historyData , setHistoryData] = React.useState(FrenchLessonsData);
    ...
    function handleClick(){
        if(formData.level === 'all'){
            setHistoryData(FrenchLessonsData);
        }
       if(formData.level === 'form1'){
           
           setHistoryData(prevData =>{
                prevData = FrenchLessonsData;
