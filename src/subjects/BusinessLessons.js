...
import { BusinessLessonsData } from "../subjectData/businessData";

import './history.css'

export default function BusinessLessons(){
    const [historyData , setHistoryData] = React.useState(BusinessLessonsData);
    ...
    function handleClick(){
        if(formData.level === 'all'){
            setHistoryData(BusinessLessonsData);
        }
       if(formData.level === 'form1'){
           
           setHistoryData(prevData =>{
                prevData = BusinessLessonsData;
