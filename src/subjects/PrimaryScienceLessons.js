...
import { ScienceLessonsData } from "../subjectData/primaryData";

import './history.css'

export default function ScienceLessons(){
    const [historyData , setHistoryData] = React.useState(ScienceLessonsData);
    ...
    function handleClick(){
        if(formData.level === 'all'){
            setHistoryData(ScienceLessonsData);
        }
       if(formData.level === 'form1'){
           
           setHistoryData(prevData =>{
                prevData = ScienceLessonsData;
