...
import { MathLessonsData } from "../subjectData/mathematicsData";

import './history.css'

export default function MathematicsLessons(){
    const [historyData , setHistoryData] = React.useState(MathLessonsData);
    ...
    function handleClick(){
        if(formData.level === 'all'){
            setHistoryData(MathLessonsData);
        }
       if(formData.level === 'form1'){
           
           setHistoryData(prevData =>{
                prevData = MathLessonsData;
