...
import { GeogLessonsData } from "../subjectData/geogData";
import './history.css'
export default function GeographyLessons(){
    const [historyData , setHistoryData] = React.useState(GeogLessonsData);
    ...
    function handleClick(){
        if(formData.level === 'all'){
            setHistoryData(GeogLessonsData);
        }
       if(formData.level === 'form1'){
           
           setHistoryData(prevData =>{
                prevData = GeogLessonsData;
