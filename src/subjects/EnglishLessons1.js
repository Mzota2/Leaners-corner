...
import { EnglishLessonsData } from "../subjectData/englishData";

import './history.css'

export default function EnglishLessons(){
    const [historyData , setHistoryData] = React.useState(EnglishLessonsData);
    ...
    function handleClick(){
        if(formData.level === 'all'){
            setHistoryData(EnglishLessonsData);
        }
       if(formData.level === 'form1'){
           
           setHistoryData(prevData =>{
                prevData = EnglishLessonsData;
